    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="info-section">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo e($resetTime); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">IP Address:</span>
                    <span class="info-value"><?php echo e($ipAddress ?? 'Not available'); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Device/Browser:</span>
                    <span class="info-value"><?php echo e($userAgent ?? 'Not available'); ?></span>
                </div>
            </div>

            <!-- Action Buttons -->
            <div class="action-buttons">
                <a href="<?php echo e($loginUrl); ?>" class="btn btn-primary">
                    <i class="fas fa-sign-in-alt"></i> Login to Account
                </a>
                <a href="<?php echo e($resetPasswordUrl); ?>" class="btn btn-secondary">
                    <i class="fas fa-key"></i> Reset Password Again
                </a>
            </div>
            ...
            <div class="security-tips">
                ...
                <ul>
                    ...
                    <li><strong>If this wasn't you:</strong> Your account may have been compromised. Please reset your password immediately.</li>
        ...
        <div class="footer">
            ...
            <p style="font-size: 12px; color: #9ca3af;">
                © <?php echo e(date('Y')); ?> Orbit IQ. All rights reserved.<br>
                This email was sent to <?php echo e($email); ?> because a password reset was performed on your account.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/tarang/Documents/Projects/Orbit IQ/backend/resources/views/emails/password-reset-notification.blade.php ENDPATH**/ ?>