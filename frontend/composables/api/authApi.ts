...
export const authApi = {
  ...
  updateProfile: (data: any) => useApiFetch('/profile', { method: 'PUT', body: data }),
  ...
  deleteAvatar: () => useApiFetch('/profile/avatar', { method: 'DELETE' }),
  ...
  getProjectStatuses: () => useApiFetch('/admin/project-statuses'),
