...
import { taskStatusApi } from '@/utils/api'
import { getContrastColor } from '@/utils/colors'
import TaskStatusModal from '@/components/modals/TaskStatusModal.vue'
...
const groupedStatuses = computed(() => {
  let filtered = taskStatuses.value
