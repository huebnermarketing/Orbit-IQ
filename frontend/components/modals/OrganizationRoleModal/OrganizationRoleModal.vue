          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-warning-800">
                This is a locked system role and cannot be modified. Only custom roles can be
                edited.
              </p>
            </div>
          </div>
...
<script lang="ts" src="./OrganizationRoleModal.ts"></script>
