          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-info-800">
                This is a system-defined status. You can edit the name, color, and sort order, but
        ...
        <form @submit.prevent="handleSubmit" class="bg-surface px-6 py-4 space-y-4">
          <div>
            <label class="block text-sm font-medium text-text-primary mb-2"
              >Status Name <span class="text-error-500">*</span></label
            >
            <input
              v-model="form.name"
              type="text"
          ...
          <div>
            <label class="block text-sm font-medium text-text-primary mb-2"
              >Status Color <span class="text-red-500">*</span></label
            >
          ...
          <div>
            ...
            <div class="flex items-center space-x-2">
              <span
                ...
                >{{ form.name || 'Status Name' }}</span
              >
              <span class="text-sm text-gray-500"
                >in {{ getCategoryLabel(form.category) || 'Category' }}</span
              >
            </div>
          </div>
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
              {{
                isLocked
                  ? 'System-defined statuses are always active'
...
<script lang="ts" src="./TaskStatusModal.ts"></script>
<style scoped src="./TaskStatusModal.css"></style>
