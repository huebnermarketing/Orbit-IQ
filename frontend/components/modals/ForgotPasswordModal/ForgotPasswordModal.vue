<template>
  <div class="fixed inset-0 z-50 overflow-y-auto">
    ...
    >
      ...
      <!-- Modal panel -->
      <div
        class="inline-block align-bottom bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
      >
          ...
          <div class="relative z-10">
            <div class="flex items-center justify-between mb-6">
              <div class="flex items-center space-x-3">
                <div
                  class="h-10 w-10 bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl flex items-center justify-center"
                >
                  <svg
              ...
              <div class="flex space-x-4 pt-6">
                ...
                >
                  <span v-if="loading" class="flex items-center justify-center">
                    <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white -ml-1 mr-2 inline-block"></div>
                    Sending...
                  </span>
            ...
            <div
              v-if="submitted"
              class="mt-6 p-4 bg-green-500/10 border border-green-500/20 rounded-xl backdrop-blur-sm"
            >
              <div class="flex">
                <svg
...
<script lang="ts" src="./ForgotPasswordModal.ts"></script>
<style scoped src="./ForgotPasswordModal.css"></style>
