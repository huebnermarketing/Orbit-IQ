              ...
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm text-blue-800">
                    <strong>Don't have an authenticator app?</strong> Download Google Authenticator,
                    Authy, or Microsoft Authenticator from your app store.
                  </p>
                </div>
              </div>
            </div>
...
<script lang="ts" src="./MfaSetupModal.ts"></script>
<style scoped src="./MfaSetupModal.css"></style>
