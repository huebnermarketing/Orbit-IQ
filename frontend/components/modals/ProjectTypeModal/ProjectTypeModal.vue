          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div>
              <label class="block text-sm font-medium text-text-primary mb-2"
                >Project Type Name <span class="text-error-500">*</span></label
              >
              <input
                v-model="form.name"
                type="text"
                required
                :disabled="isEdit && projectType?.is_system_defined"
                class="input"
                :class="{
                  'opacity-50 cursor-not-allowed': isEdit && projectType?.is_system_defined,
                }"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-text-primary mb-2"
                  >Color <span class="text-error-500">*</span></label
                >
            ...
            <div
              v-if="isEdit && projectType?.is_system_defined"
              ...
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm text-info-800">
                    This is a system-defined project type (Fixed Cost, Maintenance, Hosting, Adhoc,
                    SaaS). System-defined project types cannot be modified or deleted as they are
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-border-light">
              ...
              <button
                type="submit"
                :disabled="loading || (isEdit && projectType?.is_system_defined)"
                class="btn-primary"
                :class="{
                  'opacity-50 cursor-not-allowed': isEdit && projectType?.is_system_defined,
                }"
...
<script lang="ts" src="./ProjectTypeModal.ts"></script>
