<template>
  <div class="fixed inset-0 z-50 overflow-y-auto">
    ...
    >
      ...
      <!-- Modal panel -->
      <div
        class="inline-block align-bottom bg-surface rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full"
      >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium text-text-primary mb-2"
                >Task Name <span class="text-error-500">*</span></label
              >
              <input
                v-model="form.name"
                type="text"
            ...
            <div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex">
                  ...
                  />
                  <button type="button" @click="addTag" class="btn btn-outline ml-2">Add</button>
                </div>
              </div>
            </div>
